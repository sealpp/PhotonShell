        ...
        try:
            async for raw in websocket:
                try:
                    ...
                    await self._send_failed(websocket, msg.request_id if "msg" in dir() else "", "state_error", str(exc))
                except Exception as exc:
                    request_id = getattr(msg, "request_id", "") if "msg" in dir() else ""
                    await self._send_failed(websocket, request_id, "internal", str(exc))
        finally:
            pass
